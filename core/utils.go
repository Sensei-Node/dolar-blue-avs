...
func AbiEncodeTaskResponse(h *cstaskmanager.IOracleTaskManagerTaskResponse) ([]byte, error) {
...
func GetTaskResponseDigest(h *cstaskmanager.IOracleTaskManagerTaskResponse) ([32]byte, error) {
